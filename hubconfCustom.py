...
email_sender = 'aimllt2203@glbitm.ac.in'
email_recipient = '0101gautamkumar@gmail.com'
...
def violation_alert_generator(im0, subject='PPE Violation Detected', message_text='A PPE violation is detected'):
    ...
    temp_filename = "violation_image.jpg"  #changes made (need to be reverted,converting im0 from np.ndarray to jpg)
    cv2.imwrite(temp_filename,im0)
    prepare_and_send_email(email_sender, email_recipient, subject, message_text, temp_filename)
