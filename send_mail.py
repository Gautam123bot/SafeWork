...
def prepare_and_send_email(sender,recipient, subject, message_text, attachment):
    """
    ...
    try:
        ...
        message = create_message(
            'aimllt2203@glbitm.ac.in', recipient, subject, message_text, attachment)
        send_message(service, 'me', message)
        os.remove(attachment)
        #print("Image deleted successfully after sending email.")
...
if __name__ == "__main__":
    # Change the recepient in the following line
    prepare_and_send_email('aimllt2203@glbitm.ac.in','0101gautamkumar@gmail.com',
                           'Greeting from Gautam Kumar', 'This is a test email', 'photo.jpg')
